...
stoch_seir <- odin::odin({
  ...
  update(I) <- I + n_EI - n_IR - n_inf_flight_AtoB # n_inf_flight_leaveA 
  ...
  num_flights_leaveA <- user()                                    # Total number of flights per day leaving Location A (not used in this current paramterisation)
